...
class Dictionary(models.Model): 
        ...
        pronounciation = models.CharField(max_length=30,null = False, blank= False, help_text= "Enter the pronounciation (literally in latin script)")
        translation = models.CharField(max_length=30, help_text= "Enter the translation(s) in the desired language(s)")
